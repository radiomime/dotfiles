...
nnoremap  
nnoremap  
nnoremap  :call PANEVERT()
nmap  :Filesz.
map  :TagbarToggle
nmap o <Plug>ZoomWin
nnoremap  :call PANEHOR()
nnoremap # #zz
nnoremap * *zz
...
vnoremap // y/""
nnoremap ; :
nnoremap < :exe "vertical resize " . (winwidth(0) * 2/3)
nnoremap > :exe "vertical resize " . (winwidth(0) * 3/2)
nnoremap C :grep! "\<<cword>\>" . -r:botright copen
nnoremap G Gzz
...
set tabstop=4
set tags=./tags,tags;/Users/ethan
set textwidth=79
